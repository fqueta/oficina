...
class UserController extends Controller
{
    ...
    public function campos($dados=false,$local='index'){
        ...
        $ret = [
            ...
            // 'cnpj'=>['label'=>'CNPJ *','show'=>false,'active'=>false,'type'=>'tel','exibe_busca'=>'d-block','event'=>'mask-cnpj required','tam'=>'3','class_div'=>'div-pj '.$displayPj],
            ...
            // 'config[CodigoCiac]'=>['label'=>'CIAC','show'=>false,'active'=>false,'type'=>'text','exibe_busca'=>'d-none','event'=>'','tam'=>'2','placeholder'=>'','class_div'=>'div-pj '.$displayPj,'cp_busca'=>'config][CodigoCiac'],
            ...
            'config[Telefone]'=>['label'=>'Telefone','active'=>false,'type'=>'tel','tam'=>'3','exibe_busca'=>'d-block','event'=>' onblur=mask(this,clientes_mascaraTelefone); onkeypress=mask(this,clientes_mascaraTelefone);','cp_busca'=>'config][Telefone'],
            ...
            'id_permission'=>[
                ...
                'event'=>'',
                'tam'=>'12',
            ],'ativo'=>['label'=>'Liberar acesso','active'=>false,'type'=>'chave_checkbox','value'=>'s','checked'=>'s','exibe_busca'=>'d-block','event'=>'','tam'=>'12','arr_opc'=>['s'=>'Sim','n'=>'Não']],
